...
public class Clock
{
    ...
    private readonly DecadeCounter secondOnes;
    private readonly SenaryCounter secondTens;
    private readonly DecadeCounter minuteOnes;
    private readonly SenaryCounter minuteTens;
    private readonly DecadeCounter hourOnes;
    private readonly Mod3Counter hourTens;

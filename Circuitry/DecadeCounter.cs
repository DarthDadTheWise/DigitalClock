...
public class DecadeCounter : CompoundGate, IHaveState, IHaveDigitValue
{
    ...
    public DecadeCounter(Board board) : base(board)
    {
        jk1 = new(board);
        jk2 = new(board);
        jk3 = new(board);
    ...
    void IHaveState.RefreshState()
    {
        ...
        (andGate3 as IHaveState).RefreshState();
        (andGate4 as IHaveState).RefreshState();
